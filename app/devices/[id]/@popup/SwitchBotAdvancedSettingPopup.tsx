...
export interface SwitchBotAdvanceSettingPopupProps {
  open: boolean;
...
const SwitchBotAdvanceSettingPopup = (
  props: SwitchBotAdvanceSettingPopupProps
) => {
  const { open, device, cancel, updateSwitchBot } = props;
...
export default SwitchBotAdvanceSettingPopup;
